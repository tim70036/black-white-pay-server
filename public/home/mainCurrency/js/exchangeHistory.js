	...
	var initTable = function () {
		...
		oTable = table.DataTable({
			...
			columnDefs: [
				...
				{ targets: colMappings.amount, responsivePriority: 4, class: 'dt-center', render: numberColor },
				{ targets: colMappings.storeCurrency, responsivePriority: 5, class: 'dt-center' },
				{ targets: colMappings.createtime, responsivePriority: 6, class: 'dt-center' },
				{ targets: colMappings.comment, responsivePriority: 7, class: 'dt-center' },
			],
			...
			'footerCallback': function (row, data, start, end, display) {
				...
				$(api.column(colMappings.transTypeCode).footer()).html('總和:');
	...
	var initForm = function () {
		...
		$('#history-form').validate({
			...
			submitHandler: function (form) {
				...
				$.ajax({
					type: 'POST',
					url: '/home/mainCurrency/exchange-history/search',
					data: formData,
					timout: 30000, // 30 sec
					// Success
