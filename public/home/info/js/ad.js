...
var Ad = function () {
    ...
    var initTable = function () {
        ...
        function detailRender(data, type, row, meta) {
            return `
				<a href="/home/detail/ad?id=${row.id}" target="_blank" rel="noopener noreferrer" class="btn btn-primary btn-sm btn-block m-btn m-btn--icon" style="background-color: #4152d8; border-color: #4152d8;">
					<span>
