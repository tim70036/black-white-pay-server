...
var agentReport = function() {
		...
		$( '#agentReport-form' ).validate({
            ...
            submitHandler: function (form) {
                ...
                let data = {
                    ...
                    agentId: $("#agentId").attr("agent"),
                    memberAccount: formData.memberAccount,
                }
				$.ajax({
					type: "POST",
					url: "/home/game/agentReport/search",
					...
					success: function(response){
						...
						mApp.unblock('#agentReport-form'); // Unblock 
	...
	$('#export').on('click', function(e) {
		...
		let filename = '代理遊戲報表.xlsx';
		let sheetname = '代理遊戲報表';
