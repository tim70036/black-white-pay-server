    ...
    var initForm = function () {
        ...
        $('#announcement-form').validate({
            ...
            submitHandler: function (form) {
                ...
                mApp.block('#announcement-portlet', {
                    size: 'lg',
                    type: 'loader',
                    state: 'primary',
                    message: '更新中...'
                ...
                $.ajax({
                    type: 'POST',
                    url: '/home/detail/announcement/edit',
                    contentType: false,
                    processData: false,
                    ...
                    success: function (result) {
                        ...
                        mApp.unblock('#announcement-portlet'); // Unblock 
                        ...
                        if (!result.err) {
                            swal({
                                ...
                                // Reload page
                                window.location='/home/info/announcement';
                            });
                        } else {
                            swal({
                                title: '執行失敗',
